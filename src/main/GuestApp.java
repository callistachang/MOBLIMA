...
//		
		...
		// Ask the user if they want to 1. list ALL movies, or 2. just movies playing in
		// a certain cineplex
		// If option 2, ask them to pick the cineplex then show movies playing only in
		// that cineplex.

		// Read from an external CSV file containing movie information, filter as
		// necessary
	}
